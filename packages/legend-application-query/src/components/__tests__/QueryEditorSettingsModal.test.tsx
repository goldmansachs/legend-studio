...
test(
  ...
  async () => {
    ...
    expect(
      getByText(settingsDialog, 'Engine client base URL'),
    ).not.toBeNull();
    expect(
      getByText(settingsDialog, 'Engine client request payload compression'),
    ).not.toBeNull();
    expect(
      getByText(settingsDialog, 'Specifies if request payload should be compressed'),
    ).not.toBeNull();
    expect(
    ...
    expect(
      getByText(settingsDialog, 'Enable minimal graph'),
    ).not.toBeNull();
    expect(
      getByText(
        settingsDialog,
